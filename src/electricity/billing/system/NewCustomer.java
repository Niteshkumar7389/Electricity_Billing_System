...
public class NewCustomer extends JFrame implements ActionListener{
	...
	NewCustomer(){
		...
		long number = ran.nextLong() % 1000000;   //for 6 digit random number 
		lblmeter.setText("" + Math.abs(number));  /*setText fn takes only string so we use ""+ */
	...
	public void actionPerformed(ActionEvent e) {
		// TODO Auto-generated method stub
		if(e.getSource()==next) {
			String name = tfname.getText();   //for fetch user info
