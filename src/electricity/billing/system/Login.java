...
public class Login extends JFrame implements ActionListener{
	...
	Choice loginas;
	Login(){
		super("Login Page");  // for frame heading we use super. just below the constructor.
		getContentPane().setBackground(Color.white);
		setLayout(null);
		
		JLabel lusername = new JLabel("username");
		lusername.setBounds(300,20,100,20);  //(length 300 height 20   username size 100 width 20)
		add(lusername);
		...
		lpassword.setBounds(300,60,150,20);  //(length 300 height 20   size 100 width 20)
		add(lpassword);
		...
		logininas.setBounds(300,100,100,20);  //(length 300 height 20    size 100 width 20)
		add(logininas);
